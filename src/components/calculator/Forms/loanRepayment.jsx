                        ...
                        <Grid item xs={6}>
                            <div className={classes.margin}>
                                ...
                                <Grid container spacing={1} alignItems="center" className={classes.paper}>
                                    ...
                                    <Grid item>
                                        <TextField id="loan-amount" label="Total Loan Amount" />
                                    </Grid>
                                </Grid>
                            </div>
                        </Grid>
                    ...
                    <Grid container spacing={4}>
                        <Grid item xs={6}>
                            <div className={classes.margin}>
                                ...
                                <Grid container spacing={1} alignItems="center" className={classes.paper}>
                                    <Grid item>
                                        <TextField id="interest-rate" label="Enter interest rate in %" />
                                    </Grid>
                                    <Grid item>
                        ...
                        <Grid item xs={6}>
                            <div className={classes.margin}>
                                ...
                                <Grid container spacing={1} alignItems="center" className={classes.paper}>
                                    ...
                                    <Grid item>
                                        <TextField id="monthly-installment" label="Enter monthly payment"/>
                                    </Grid>
                                </Grid>
                            </div>                        
                        </Grid>
